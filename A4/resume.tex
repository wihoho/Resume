...
% \resheading{Tech Stack}
% \begin{description}

% \item {\bf Language:} Java (3 years+), Python (3 years), C# (1.5 years), Scala (1 year)
% Data: Spark, Kafka, Hive, Alluxio, Cassandra, Luigi, Celery, Jupyter, Zeppelin, ElasticSearch
% Infra: AWS, Mesos, Marathon, Kubernetes, Docker, Traefik, Ansible, Teamcity, Jenkins, Sumologic
% Backend: Spring, REST, SOA, ASP.NET, Thrift, Flask, Redis, PostgreSQL, Sybase
% Frontend: AngularJS, Bootstrap, SocketIO, Google Maps API
